pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = "navnathkorde/dsa360-${DATE_TIME}"
    ...
    stages {
        stage('Get Code') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/navnath-korde/MyDSA360.git'
            }
        }
            ...
            steps {
                script {
                    ...
                    existingImages.split('\n').each { img ->
                        if (img.contains("navnathkorde/dsa360-")) {
